...
let nameInputPlace = formCardElement.querySelector('.popup__forms_name_pp');
let photoInputPlace = formCardElement.querySelector('.popup__forms_photo_pp');
...
function cardSubmitHandler (event) {
    event.preventDefault();
    const namePlace = document.querySelector('.popup__forms_name_pp');
    const imagePlace = document.querySelector('.popup__forms_photo_pp');
